				...
				<div class="box_1">
					...
					<div class="clearfix goodsBox" style="border: none; padding: 11px 0 10px 0px;">
						<c:forEach items="${roomsList}" var="rooms">
							<div class="goodsItem">
								<a href="index/roomsdetail.action?id=${rooms.roomsid }"><img src="${rooms.image }" alt="${rooms.roomsno }" class="goodsimg" /></a><br />
								<p>
									<a href="index/roomsdetail.action?id=${rooms.roomsid }" title="${rooms.roomsno }">${rooms.roomsno }</a>
								</p>
								价格：<font class="shop_s">￥${rooms.price }元/天</font><br />
							</div>
						</c:forEach>
					</div>
