							...
							<form action="index/login.action" method="post" name="myform">
								<table width="60%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input class="inputBg" style="width: 90px;" type="text"
											id="checkcode" name="checkcode" placeholder="请输入验证码" maxlength="4" /><img src="img/getVerify.action"
											width="110" height="34" id="verifyCodeImage" onclick="this.src=this.src+'?'"></td>
									</tr>
									<tr>
