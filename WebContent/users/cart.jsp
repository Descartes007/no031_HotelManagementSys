		...
		<div class="flowBox">
			...
			<table width="99%" align="center" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
				...
				<c:forEach items="${cartList}" var="cart">
					<tr>
						<td bgcolor="#ffffff" align="center" style="width: 300px;"><a href="index/detail.action?id=${cart.foodsid }"
							target="_blank"><img style="width: 80px; height: 80px;" src="${cart.image }" border="0"
								title="${cart.foodsname }" /> </a> <br /> <a href="index/detail.action?id=${cart.foodsid }" target="_blank"
							class="f6">${cart.foodsname }</a></td>
