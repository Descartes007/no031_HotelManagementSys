...
<body>
	<nav class="breadcrumb">
		...
		员工列表 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			...
			<table class="table table-border table-bordered table-bg">
				...
				<c:forEach items="${employList}" var="employ">
					<tr class="text-c">
						...
						<td><c:if test="${employ.status eq '在职'}">
								<a href="employ/status.action?id=${employ.employid}">离职</a>&nbsp;&nbsp;
								<a href="employ/getEmployById.action?id=${employ.employid}"><i class="Hui-iconfont">&#xe6df;</i></a>&nbsp;&nbsp;
						</c:if> <a href="employ/deleteEmploy.action?id=${employ.employid}"
