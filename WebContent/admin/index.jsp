...
<body>
	...
	<div class="loginWraper">
		<div id="loginform" class="loginBox">
			<p style="font-size: 28px;font-weight: bold;text-align: center;color: white;letter-spacing: 2px;margin-bottom: 30px;">酒店管理系统</p>
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8">
						<input type="radio" id="role" name="role" value="管理员">管理员 &nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
							id="role" name="role" value="员工" checked>员工
					</div>
				</div>
				<div class="row cl">
