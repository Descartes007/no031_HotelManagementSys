...
<body>
	<nav class="breadcrumb">
		...
		回复意见反馈<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="complains/getComplainsById.action?id=${complains.complainsid }" title="刷新"> <i class="Hui-iconfont">&#xe68f;</i></a>
		&nbsp;&nbsp; &nbsp;<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="complains/getAllComplains.action" title="返回"> <i class="Hui-iconfont">&#xe66b;</i>
		</a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="complains/updateComplains.action" name="myform"
			method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">内容</label>
				<div class="formControls col-xs-8 col-sm-9">
					${complains.contents}<input type="hidden" name="contents" class="input-text" id="contents"
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="complainsid" id="complainsid" value="${complains.complainsid}" /><input type="hidden"
						...
						type="hidden" name="status" id="status" value="已回复" /> <input type="hidden" id="basepath" value="<%=basePath%>" />
