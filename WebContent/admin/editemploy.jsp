...
<body>
	<nav class="breadcrumb">
		...
		编辑员工<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="employ/getEmployById.action?id=${employ.employid }" title="刷新"> <i class="Hui-iconfont">&#xe68f;</i></a>
		&nbsp;&nbsp; &nbsp;<a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px"
			href="employ/getAllEmploy.action" title="返回"> <i class="Hui-iconfont">&#xe66b;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="employ/updateEmploy.action" name="myform"
			method="post">
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="sex" value="男" title="男" ${employ.sex == "男"?"checked":""}>男
					&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="sex" value="女" title="女" ${employ.sex == "女"?"checked":""}>女
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">出生日期</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="birthday" class="input-text" id="birthday" value="${employ.birthday}"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="salary" class="input-text" id="salary" value="${employ.salary}" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				<div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2">
					<input type="hidden" name="employid" id="employid" value="${employ.employid}" /><input type="hidden" name="status"
						id="status" value="${employ.status}" /><input type="hidden" name="password"
						id="password" value="${employ.password}" /> <input type="hidden" name="addtime" id="addtime"
						value="${employ.addtime}" /> <input type="hidden" id="basepath" value="<%=basePath%>" />
