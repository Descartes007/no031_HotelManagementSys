...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>酒店采购管理 <span class="c-gray en">&gt;</span> 酒店采购查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="9">酒店采购查询</th>
				</tr>
				<tr class="text-c">
					<th class="center">采购单号</th>
					<th class="center">采购货物</th>
			...
			<c:forEach items="${buyList}" var="buy">
				<tr class="text-c">
					<td class="center">${buy.bno}</td>
					<td class="center">${buy.goodsname}</td>
					<td class="center">${buy.price}</td>
					<td class="center">${buy.num}</td>
					<td class="center">${buy.total}</td>
					<td class="center">${buy.addtime}</td>
					<td class="center">${buy.manager}</td>
		...
		<div class="text-c">
			<form action="buy/queryBuyByCond.action" name="myform" method="post">
				查询条件： <span class="select-box" style="width: 200px;"><select name="cond" class="select">
						<option value="bno">按采购单号查询</option>
						<option value="goodsname">按采购货物查询</option>
						...
						<option value="manager">按经手人查询</option>
