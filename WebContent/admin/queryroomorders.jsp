...
<body>
	<nav class="breadcrumb">
		<i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span>客房订单管理 <span class="c-gray en">&gt;</span> 客房订单查询 <a
	...
	<div class="page-container">
		<table class="table table-border table-bordered table-bg">
			<thead>
				<tr>
					<th scope="col" colspan="9">客房订单查询</th>
				</tr>
				<tr class="text-c">
			...
			<c:forEach items="${roomordersList}" var="roomorders">
				<tr class="text-c">
					<td class="center">${roomorders.ordercode}</td>
					<td class="center">${roomorders.username}</td>
					<td class="center">${roomorders.roomsno}</td>
					<td class="center">${roomorders.addtime}</td>
					<td class="center">${roomorders.thestart}</td>
					<td class="center">${roomorders.theend}</td>
					<td class="center">${roomorders.status}</td>
					<td class="center">${roomorders.memo}</td>
				</tr>
			</c:forEach>
		</table>
		<div class="cl pd-5 mt-20"></div>
		<div class="text-c">
			<form action="roomorders/queryRoomordersByCond.action" name="myform" method="post">
