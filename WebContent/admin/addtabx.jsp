...
<body>
	<nav class="breadcrumb">
		...
		新增餐桌 <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="tabx/createTabx.action"
			title="刷新"><i class="Hui-iconfont">&#xe68f;</i></a>
	</nav>
	<article class="page-container">
		<form class="form form-horizontal" id="form-article-add" action="tabx/addTabx.action" name="myform" method="post">
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">餐桌名称</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="tabxname" class="input-text" id="tabxname" placeholder="请输入餐桌名称" />
				</div>
			</div>
			<div class="row cl">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="num" class="input-text" id="num" placeholder="请输入用餐人数" />
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">餐桌类型</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="radio" name="cate" value="散台" title="散台" checked>散台 &nbsp;&nbsp;&nbsp;&nbsp;<input type="radio"
						name="cate" value="包房" title="包房">包房
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-2">餐桌位置</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" name="place" class="input-text" id="place" placeholder="请输入餐桌位置" />
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					...
					<textarea class="textarea" name="contents" id="contents" placeholder="请输入餐桌介绍"> </textarea>
